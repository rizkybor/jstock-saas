...
{
    /**
     * Same province/regency/district/village shape as tenants/client_addresses
     * — "Alamat" on the supplier form now uses the same cascading wilayah
    ...
    {
        Schema::table('warehouse_suppliers', function (Blueprint $table) {
