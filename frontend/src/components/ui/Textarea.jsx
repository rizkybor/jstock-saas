  ...
  return (
    <label className="flex flex-col gap-1.5 text-sm" htmlFor={textareaId}>
      ...
      <textarea
        id={textareaId}
        rows={rows}
        className={`resize-y rounded border bg-surface px-2.5 py-2 text-[15px] text-ink placeholder:text-ink-faint focus:outline-none focus:ring-[3px] focus:ring-[rgba(0,117,222,0.12)] ${
